...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, SheetContentProps>(
  ({ side = "right", className, children, hasTitle = false, hasDescription = false, ...props }, ref) => (
    <SheetPortal>
      <SheetOverlay />
      <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
        {!hasTitle && <SheetPrimitive.Title className="sr-only">Sheet Dialog</SheetPrimitive.Title>}
        {!hasDescription && (
          <SheetPrimitive.Description className="sr-only">Sheet Dialog Content</SheetPrimitive.Description>
        )}
