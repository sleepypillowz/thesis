                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h1 className="text-2xl md:text-3xl font-bold">
                      {treatmentDetails.patient_info.first_name} {treatmentDetails.patient_info.middle_name && `${treatmentDetails.patient_info.middle_name.charAt(0)}. `}{treatmentDetails.patient_info.last_name}
                    </h1>
          ...
          {isLoading ? (
            <div className="flex justify-center items-center h-64">
              <div className="relative">
                ...
                <p className="mt-4 text-gray-600 font-medium">Loading treatment data...</p>
              </div>
            </div>
          ) : error ? (
                ...
                <div className="space-y-8">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h2 className="text-lg font-semibold text-gray-900">
                        Treatment on {formatDate(treatmentDetails.recent_treatment.created_at)}
                      </h2>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                      ...
                      <div className="p-5">
                        {treatmentDetails.recent_treatment.diagnoses.length > 0 ? (
                          <ul className="divide-y divide-gray-100">
                            {treatmentDetails.recent_treatment.diagnoses.map((d, index) => (
                              <li key={`${d.diagnosis_code}-${index}`} className="py-3">
                                <div className="flex items-start">
                                  ...
                                  <p className="text-gray-700">{d.diagnosis_description}</p>
                                </div>
                                {d.diagnosis_date && (
                                  <p className="text-sm text-gray-500 mt-1 ml-12">
                                    Diagnosed: {formatDate(d.diagnosis_date)}
                                  </p>
                                )}
                              </li>
                            ))}
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                      ...
                      <div className="p-5">
                        {treatmentDetails.recent_treatment.prescriptions.length > 0 ? (
                          <ul className="divide-y divide-gray-100">
                            {treatmentDetails.recent_treatment.prescriptions.map((p, index) => (
                              <li key={`${p.medication}-${index}`} className="py-3">
                                <div className="flex items-center">
                                  ...
                                  <div className="flex-1">
                                    <h4 className="text-base font-medium text-gray-900">{p.medication}</h4>
                          ...
                          <div className="flex flex-col items-center justify-center h-32 text-gray-400">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v10m2 2h.01" />
                            </svg>
                ...
                <div>
                  {treatmentDetails.previous_treatments.length > 0 ? (
                    <div className="space-y-6">
                      <h2 className="text-lg font-semibold text-gray-900">Previous Treatments</h2>
                      
                      <div className="relative">
                        <div className="absolute left-5 h-full w-0.5 bg-gray-200"></div>
                        <div className="space-y-8">
                          {treatmentDetails.previous_treatments.map((treatment, index) => (
                                  ...
                                  <div className="p-5">
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                                      <div className="flex items-center mb-2 sm:mb-0">
                                        ...
                                        <span className="font-medium text-gray-700">{formatDate(treatment.created_at)}</span>
                                      </div>
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4 mb-4">
                                      <h3 className="font-medium text-gray-700 mb-2">Treatment Notes</h3>
                                    ...
                                    <details className="group">
                                      ...
                                      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="bg-gray-50 rounded-lg p-4">
                                          <h3 className="font-medium text-gray-700 mb-3">Diagnoses</h3>
                                          {treatment.diagnoses.length > 0 ? (
                                            <ul className="space-y-2">
                                              {treatment.diagnoses.map((d, idx) => (
                                                <li key={`${d.diagnosis_code}-${idx}`} className="bg-white p-2 rounded-lg border border-gray-100">
                                                  <div className="flex items-start">
                                                    ...
                                                    <span className="text-gray-600">{d.diagnosis_description}</span>
                                                  </div>
                                                </li>
                                              ))}
                                            </ul>
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-4">
                                          <h3 className="font-medium text-gray-700 mb-3">Prescriptions</h3>
                                          {treatment.prescriptions.length > 0 ? (
                                            <ul className="space-y-2">
                                              {treatment.prescriptions.map((p, idx) => (
                                                <li key={`${p.medication}-${idx}`} className="bg-white p-2 rounded-lg border border-gray-100">
                                                  <div className="font-medium text-gray-700">{p.medication}</div>
                                                  <div className="text-sm text-gray-500 flex flex-wrap gap-2 mt-1">
                                                    <span className="px-2 py-0.5 bg-gray-50 rounded">{p.dosage}</span>
                                                    <span className="px-2 py-0.5 bg-gray-50 rounded">{p.frequency}</span>
                                                  </div>
                                                </li>
                                              ))}
                                            </ul>
                    ...
                    <div className="flex flex-col items-center justify-center p-12 text-gray-400">
                      ...
                      <h3 className="text-xl font-medium text-gray-500 mb-1">No Previous Treatments</h3>
                      <p className="text-gray-400">This patient doesn't have any treatment history records.</p>
                    </div>
                  )}
                </div>
              )}
