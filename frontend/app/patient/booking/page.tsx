      ...
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <div className="card mx-auto mt-12 max-w-lg">
          <form action="#" method="POST" className="space-y-6">
            ...
            <div>
              <label htmlFor="date" className="mb-2 block text-sm font-medium">Preferred Appointment Date</label>
              <input type="date" id="date" name="date" required
                className="block w-full rounded-lg border border-gray-300 p-2.5 focus:border-sky-500 focus:ring-sky-500" />
            </div>

            <div>
              <label htmlFor="time" className="mb-2 block text-sm font-medium">Preferred Appointment Time</label>
            ...
            <div>
              <label htmlFor="message" className="mb-2 block text-sm font-medium">Additional Notes</label>
