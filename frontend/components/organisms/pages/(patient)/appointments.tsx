...
export default function ReferralsPage() {
  ...
  useEffect(() => {
    fetchReferrals();
    }, []); // Added empty dependency array to prevent infinite fetching
  ...
  return (
    <div className="w-full bg-slate-50 min-h-screen px-6 py-8">
      <div className="max-w-full mx-auto mb-8">
        ...
        <p className="text-gray-500 mt-2">Manage your patient referrals and appointments</p>
      </div>
      ...
      {referrals.length === 0 ? (
        ...
        <div className="space-y-6 w-full">
          {referrals.map((referral) => {
            ...
            const formattedCreated = format(createdAt, 'MMMM d, yyyy');
            ...
            return (
              <div key={referral.id} className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 w-full">
                <div className="p-6">
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="ml-3">
                            ...
                            <div className="mt-1 text-sm text-blue-700">
                              ...
                              <p className="font-semibold mt-1">{countdownText}</p>
                            </div>
                          </div>
                        </div>
                      </div>
