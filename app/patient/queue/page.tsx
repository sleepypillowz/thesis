  ...
  return (
    <main className="flex-1 px-8 py-8 pt-24">
      <div className="flex flex-row justify-center gap-4">
        <div
          className="flex h-96 w-80 max-w-sm flex-col items-center justify-center rounded-lg border-2 border-solid border-gray-300 p-6 bg-white">
      ...
      <div className="flex justify-center pt-8">
        <div className="flex w-96 max-w-sm flex-col rounded-lg border-2 border-solid border-gray-300 p-6 bg-white">
